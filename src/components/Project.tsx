    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            ...
            <div className="project">
                <img src={mock10} className="zoom" alt="Pixel Post" width="100%"/>
                <h2>Pixel Post</h2>
            ...
            <div className="project">
                <a className="no-icon" href="https://students.pages.coco.study/ss22/aai/team3/" target="_blank" rel="noreferrer"><img src={mock09} className="zoom" alt="Buchstaben- und Ziffern-Erkenner" width="100%"/></a>
            ...
            <div className="project">
                <a className="no-icon" href="https://sit.gsa.ac.uk/winter-school" target="_blank" rel="noreferrer"><img src={mock07} className="zoom" alt="GSA Winterschool 2024" width="100%"/></a>
            ...
            <div className="project">
                <a className="no-icon" href="https://joe-30.gitbook.io/open-design" target="_blank" rel="noreferrer"><img src={mock08} className="zoom" alt="Resistor Twister" width="100%"/></a>
            ...
            <div className="project">
                <a className="no-icon" href="https://youtu.be/14XJ3Iw63Uw" target="_blank" rel="noreferrer"><img src={mock06} className="zoom" alt="FeelMyMoods" width="100%"/></a>
            ...
            <div className="project">
                <img src={mock04} className="zoom" alt="Die Eierlegende Wollmilchküche" width="100%"/>
            ...
            <div className="project">
                <a className="no-icon" href="https://youtu.be/Eikem5Jtn0U" target="_blank" rel="noreferrer"><img src={mock05} className="zoom" alt="CupCup" width="100%"/></a>
            ...
            <div className="project">
                <a className="no-icon" href="https://jhaseloh.pages.coco.study/gestaltungsportfolio-generative-gestaltung-ws-202122/" target="_blank" rel="noreferrer"><img src={mock03} className="zoom" alt="Gestaltungsportfolio Generative Gestaltung" width="100%"/></a>
